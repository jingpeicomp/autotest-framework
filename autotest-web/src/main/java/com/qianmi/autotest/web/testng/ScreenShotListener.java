...
public class ScreenShotListener implements ITestListener {
    ...
    private void saveScreenShot(ITestResult result) {
        ...
        String filePath;
        try {
            WebDriver webDriver = BeanFactory.getBean(WebDriver.class);
            if (null == webDriver) {
                return;
            }
            ...
            log.error("Fail to save screenshot {}", fileName, e);
            return;
        }
        ...
        if (StringUtils.isNoneBlank(filePath)) {
            ...
            //把截图写入到Html报告中方便查看
            Reporter.log("<img src=\"./screenshot/" + fileName + ".jpg\" width=\"800px\"/>");
        }
    }
}
